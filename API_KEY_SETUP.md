...
|--------|------|----------|----------|
| `THE_ODDS_API_KEY` | API Key | ✅ YES | [Get from here](https://the-odds-api.com/) |
...
| `TEAMS_WEBHOOK_URL` | Webhook | ❌ Optional | Teams Outgoing Webhook |
| `TEAMS_WEBHOOK_SECRET` | Webhook | ❌ Optional | Teams Outgoing Webhook |
