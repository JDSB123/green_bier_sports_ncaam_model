...
CREATE TABLE IF NOT EXISTS betting_recommendations (
    ...
    implied_prob         DECIMAL(6,5),
    market_prob          DECIMAL(6,5),
    market_prob_novig    DECIMAL(6,5),
    market_hold_percent  DECIMAL(6,3),
    prob_edge            DECIMAL(7,6),
    ...
    closing_line_captured_at TIMESTAMPTZ,
    clv                 DECIMAL(5,2),
    clv_percent          DECIMAL(6,3),
    market_line_at_bet   DECIMAL(5,2),
    pnl                 DECIMAL(10,2),
    created_at          TIMESTAMPTZ DEFAULT NOW(),
