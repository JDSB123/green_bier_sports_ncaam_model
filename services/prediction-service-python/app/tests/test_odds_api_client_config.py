...
def test_env_defaults_mapping(monkeypatch):
    ...
    monkeypatch.setenv("MARKETS_FULL", "spreads,totals,h2h")
    monkeypatch.setenv("MARKETS_H1", "spreads_h1,totals_h1,h2h_h1")
    monkeypatch.setenv("MARKETS_H2", "spreads_h2,totals_h2,h2h_h2")
    ...
    assert client.markets_full == "spreads,totals,h2h"
    assert client.markets_h1 == "spreads_h1,totals_h1,h2h_h1"
    assert client.markets_h2 == "spreads_h2,totals_h2,h2h_h2"
