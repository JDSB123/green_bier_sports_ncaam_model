...
# Use the canonical master for all coverage checks
BACKTEST_MASTER = "manifests/canonical_training_data_master.csv"
...
def audit_data_existence(result: AuditResult, verbose: bool = False) -> None:
    ...
    required_blobs = {
        ...
        # Canonical master (exclusive source of truth)
        "canonical_master": "manifests/canonical_training_data_master.csv",
        # Legacy/archival only (do not use):
...
def _get_alias_lookup() -> dict:
    """Legacy/archival only: team alias lookup is deprecated. Always use canonical master."""
    return {}
...
def audit_team_resolution(result: AuditResult, verbose: bool = False) -> None:
    """Team resolution audit is deprecated. Canonical master is the exclusive source of truth."""
    print_header("AUDIT 7: TEAM RESOLUTION (DEPRECATED)")
    print_info("Team resolution audit skipped. Canonical master is the exclusive source of truth.")
...
def audit_ingestion_recency(result: AuditResult, verbose: bool = False) -> None:
    ...
    try:
        ...
        critical_blobs = [
            ...
            # "backtest_datasets/team_aliases_db.json", # Legacy/archival only
        ]
